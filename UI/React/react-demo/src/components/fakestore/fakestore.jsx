...
export function FakeStore(){
    ...
    const[products, setProducts] = useState([{id:0, title:null, price:0, image:null, description:null, rating:{rate:0, count:0},category:null}]);
    ...
    return(
        <div className="container-fluid">
            <header className="border border-1 p-2 d-flex justify-content-between mt-2">
                <h2>FakeStore</h2>
                <div>
                    <div className="input-group">
                        <input type="text" className="form-control" placeholder="Search Fakestore.com"></input>
